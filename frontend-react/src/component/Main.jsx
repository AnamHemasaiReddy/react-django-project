  ...
  return (
    <div className='container'>
        <div className='text-center p-5 bg-light-darker rounded'>
          <h1 className='text-light p-5 bold'>portfolio</h1>
          <p className='text-light lead'><i>I am a passionate Data Science enthusiast with strong expertise in data analysis, machine learning, deep learning, and data-driven decision-making. My portfolio showcases projects that involve cleaning, processing, analyzing, and visualizing data, as well as building predictive models and deploying AI-powered solutions.
...
Version Control: Git, GitHub, GitLab</i></p>
